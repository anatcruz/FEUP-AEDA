...
/** Allows an admin to see the a deliveryperson's earnings of the Company of a specific Base.
       * The user must select the deliveryperson he wants to see the earnings from.
       * @param company is our Company Ugh-Eats.
*/
